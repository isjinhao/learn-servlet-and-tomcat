 ...
 * @Date 2021/1/8 9:39
 */
public class TomcatManualBootStrap {
    ...
    public static void main(String[] args) throws LifecycleException {
        ...
        tomcat.setBaseDir(TomcatManualBootStrap.createTomcatBaseDir());
        ...
        context.setParentClassLoader(TomcatManualBootStrap.class.getClassLoader());
