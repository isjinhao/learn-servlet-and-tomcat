...
@WebServlet(
        name = "helloAsian",
        urlPatterns = {"/helloAsian"}
)
public class HelloAsianServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws IOException {
        ...
        outputStream.write("hello asian : simple servlet jar".getBytes());
        outputStream.flush();
        outputStream.close();
    ...
    public void init() throws ServletException {
        System.out.println("init HelloAsianServlet");
    }
